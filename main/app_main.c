...
static esp_mqtt5_publish_property_config_t publish_property = {
    ...
    .topic_alias = 0,
    .response_topic = "/esp32c3test/response",
...
static void mqtt5_event_handler(void *handler_args, esp_event_base_t base, int32_t event_id, void *event_data)
{
    ...
    case MQTT_EVENT_CONNECTED:
        ...
        msg_id = esp_mqtt_client_publish(client, "/esp32c3test/qos1", "data_3", 0, 1, 1);
        ...
        msg_id = esp_mqtt_client_subscribe(client, "/esp32c3test/qos0", 0);
    ...
    case MQTT_EVENT_SUBSCRIBED:
        ...
        print_user_property(event->property->user_property);
        esp_mqtt5_client_set_publish_property(client, &publish_property);
        msg_id = esp_mqtt_client_publish(client, "/esp32c3test/qos0", "data", 0, 0, 0);
        ESP_LOGI(TAG, "sent publish successful, msg_id=%d", msg_id);
        break;
